...
parser.add_argument(
    ...
    action="store",
    required=True,
    help="Input VCF file. Should be a multisample vcf, though it should theoretically work with a single sample.",
)
parser.add_argument(
    "-o", "--out", action="store", required=True, help="Output filename"
)
parser.add_argument(
    "-c",
    "--chromosome",
...
parser.add_argument(
    ...
    action="store_true",
    required=False,
    help="Set if the VCF is gzipped.",
)
