...
timesweeper train -i training_data.pkl --hft -n Sample_Size_10 yaml ${configfile}
timesweeper plot_training -i training_data.pkl -n Sample_Size_10 -o sample_size_20/images
