...
timesweeper train -i 01selcoeff_training_data.pkl -d aft -n Sel_Coeff_0.1 -y config.yaml
timesweeper train -i 01selcoeff_training_data.pkl -d hft -n Sel_Coeff_0.1 -y config.yaml
