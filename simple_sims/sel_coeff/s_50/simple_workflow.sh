...
timesweeper train -i 05selcoeff_training_data.pkl -d aft -n Sel_Coeff_0.5 -y config.yaml
timesweeper train -i 05selcoeff_training_data.pkl -d hft -n Sel_Coeff_0.5 -y config.yaml
